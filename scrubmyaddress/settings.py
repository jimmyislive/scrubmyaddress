# Django settings for scrubmyaddress project.
...
SECRET_KEY = 'fk$=y=bew)%0c*v*sag9kz7*#5d+v9k-ul67urmyv_ldzi$fkc'
...
ROOT_URLCONF = 'scrubmyaddress.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'scrubmyaddress.wsgi.application'
